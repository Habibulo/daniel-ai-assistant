# Suggested Expertise for Review

Review each suggestion. To approve: create the file in the appropriate `expertise/` subdirectory and update `expertise/INDEX.md`. Then delete the entry here.
...
1. Create `expertise/{category}/{name}.md` with proper frontmatter
2. Add entry to `expertise/INDEX.md`
